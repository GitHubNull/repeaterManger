...
public class DataImporter {
     ...
     * 从SQLite数据库导入数据
     */
    public void importFromSQLite(String sourceDbPath) {
        try {
            // 检查源数据库文件
            ...
            // 获取数据库连接
            Connection sourceConn = DriverManager.getConnection("jdbc:sqlite:" + sourceDbPath);
            Connection targetConn = DatabaseManager.getInstance().getConnection();
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    if (affectedRows > 0) {
                        ...
                        if (generatedKeys.next()) {
                            ...
                            BurpExtender.printOutput("[+] 导入请求成功，ID: " + newId);
                        }
                    }
                ...
                // 提交事务
                targetConn.commit();
                BurpExtender.printOutput("[+] 数据导入完成");
    ...
    private void doImportFromSQLite(File sourceFile) throws IOException, SQLException {
        ...
        try {
            ...
            try {
                ...
                if (mainUI != null && mainUI.getClass().getName().equals("oxff.top.ui.MainUI")) {
                    // 调用自动保存服务停止方法
    ...
    private void refreshUIAfterImport() {
        ...
        try {
            ...
            if (repeaterUIObj != null && repeaterUIObj instanceof EnhancedRepeaterUI) {
                EnhancedRepeaterUI repeaterUI = (EnhancedRepeaterUI) repeaterUIObj;
    ...
    private Object findEnhancedRepeaterUI(java.awt.Component component) {
        ...
        if (component.getClass().getName().equals("oxff.top.EnhancedRepeaterUI")) {
            return component;
        }
